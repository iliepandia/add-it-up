...
[Open the game](https://iliepandia.github.io/add-it-up/addition-game.html?ver=110)
...
src/
  ...
  prizes & progress
    ...
    prizeMerge.js four-of-a-kind (both modes): badge, merge into a present,
                  open it for a new prize from that group's own pool
